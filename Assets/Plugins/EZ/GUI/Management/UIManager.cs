...
#if UNITY_IPHONE || UNITY_ANDROID && !(UNITY_4_1 || UNITY_4_2 || UNITY_4_3 || UNITY_4_4 || UNITY_4_5 || UNITY_4_6 || UNITY_4_7 || UNITY_4_8 || UNITY_4_9)
	/// <summary>
...
#elif UNITY_4_1 || UNITY_4_2 || UNITY_4_3 || UNITY_4_4 || UNITY_4_5 || UNITY_4_6 || UNITY_4_7 || UNITY_4_8 || UNITY_4_9
			// Do nothing as Unity 4.1 and up don't allow separate keyboard orientation settings
#else
...
// 				else
...
#else
	#if UNITY_FLASH
						    Component[] comps = hit.collider.gameObject.GetComponents<Component>();
	...
	protected void PollKeyboard()
	{
		...
		|| iKeyboard.wasCanceled)
	...
	#endif
			{
				...
				IKeyFocusable fo = (IKeyFocusable) focusObj;
				FocusObject = null;
				fo.Commit();
				return;
			}
	...
	protected void ProcessKeyboard()
	{
		...
		foreach (char c in Input.inputString)
		{
			...
			if (c == '\b')
			{
				// Backspace is only valid if the insertion point
				// isn't at the beginning of the string:
				if (insert <= 0)
					continue;
...
#if UNITY_IPHONE || UNITY_ANDROID
				string placeholderText = controlText;

				if(!Application.isEditor)
				{
					if (((IKeyFocusable)focusObj).Password)
						placeholderText = "";

#if UNITY_3_5 || UNITY_3_6 || UNITY_3_7 || UNITY_3_8 || UNITY_3_9 || UNITY_4_0 || UNITY_4_1 || UNITY_4_2 || UNITY_4_3 || UNITY_4_4 || UNITY_4_5 || UNITY_4_6 || UNITY_4_7 || UNITY_4_8 || UNITY_4_9
					TouchScreenKeyboard.hideInput = kbInfo.hideInput;
					iKeyboard = TouchScreenKeyboard.Open(controlText, kbInfo.type, kbInfo.autoCorrect, kbInfo.multiline, kbInfo.secure, kbInfo.alert, placeholderText);
#else
					iPhoneKeyboard.hideInput = kbInfo.hideInput;
					iKeyboard = iPhoneKeyboard.Open(controlText, kbInfo.type, kbInfo.autoCorrect, kbInfo.multiline, kbInfo.secure, kbInfo.alert, placeholderText);
#endif
